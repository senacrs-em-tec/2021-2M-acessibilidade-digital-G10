...
<header>
        <div class="container" id="topnav">
                        ...
                        <l class="nav-link" style="--i: .85s">
                            ...
                            <div class="dropdown">
                                <ul>
                                  ...
                                  <h6 style="margin-top: 30px; margin-right:5px; color: white;">DislexicMode</h6><label class="switch" id="switch">
            ...
            <div class="hamburger-menu-container" style="margin-right: 10px;">
